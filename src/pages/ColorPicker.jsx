  ...
  <GlassCard className="m-2 md:m-10 mt-24 p-2 md:p-10 rounded-3xl">
    ...
    <div className="text-center">
      ...
      <div className="flex justify-center items-center gap-20 flex-wrap">
        <div>
          <p className="text-2xl font-semibold mt-2 mb-4 text-slate-900 dark:text-white">Inline Pallete</p>
          <CustomColorPicker id="inline-palette" mode="Palette" />
        </div>
        <div>
          <p className="text-2xl font-semibold mt-2 mb-4 text-slate-900 dark:text-white">Inline Picker</p>
